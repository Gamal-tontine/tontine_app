...
class AcquitementForm(forms.ModelForm):
    amount = forms.IntegerField(required=True,min_value=1000,help_text='minimum: 10000',label='Montant',widget=forms.NumberInput(attrs={'class':'form-control','readonly': 'readonly'}))
